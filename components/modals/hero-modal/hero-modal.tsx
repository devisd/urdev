...
const HeroModalContent = ({ mode, setMode, title }: { mode: 'contact' | 'brief', setMode: (m: 'contact' | 'brief') => void, title: string }) => (
    mode === 'contact' ? (
        <>
            <h2 className="text-2xl md:text-4xl font-extrabold mb-2 md:mb-4 text-secondary dark:text-secondary-foreground text-center">{title}</h2>
            <p className="text-sm md:text-base text-center text-secondary dark:text-secondary-foreground mb-4 md:mb-10">
        ...
        <>
            <h2 className="text-2xl md:text-4xl font-extrabold mb-2 md:mb-4 text-secondary dark:text-secondary-foreground text-center">Бриф на разработку сайта</h2>
            <span className="text-sm md:text-base text-secondary dark:text-secondary-foreground text-center mb-4 md:mb-10 block">
